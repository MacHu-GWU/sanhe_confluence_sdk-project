# -*- coding: utf-8 -*-
#
# sanhe_confluence_sdk documentation build configuration file, created by
...
import sanhe_confluence_sdk as package
...
# Add data for Jinja2
try:
    from sanhe_confluence_sdk.docs import doc_data
except:
    doc_data = dict()
